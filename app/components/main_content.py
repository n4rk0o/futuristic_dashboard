        ...
        rx.el.div(
            rx.cond(
                ...
                rx.el.div(
                    ...
                    rx.el.div(
                        rx.el.div(
                            rx.el.div(class_name="size-3 rounded-full bg-cyan-400"),
                            rx.el.p("CPU", class_name="text-xs text-gray-400"),
                            class_name="flex items-center gap-2",
                        ),
                        rx.el.div(
                            rx.el.div(class_name="size-3 rounded-full bg-purple-500"),
                            rx.el.p("Memory", class_name="text-xs text-gray-400"),
                            class_name="flex items-center gap-2",
                        ),
                        rx.el.div(
                            rx.el.div(class_name="size-3 rounded-full bg-teal-500"),
                            rx.el.p("Network", class_name="text-xs text-gray-400"),
                            class_name="flex items-center gap-2",
                        ),
